...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/07 14:08:02 by dmenard           #+#    #+#             */
/*   Updated: 2017/01/07 14:46:30 by dmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char		*spft_precipad(char *str, short int value, t_conv *cd)
{
	char	*tstr;
...
t_conv *cd, char *str, short int v, int *sign)
{
	char	*tstr;
...
int				pcft_hd(va_list ap, t_conv *cd)
{
	...
	sign = 0;
	v = (short int)va_arg(ap, intmax_t);
