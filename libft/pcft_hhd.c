...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/07 14:40:44 by dmenard           #+#    #+#             */
/*   Updated: 2017/01/07 14:42:37 by dmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char		*spft_precipad(char *str, char value, t_conv *cd)
{
	char	*tstr;
...
static char		*spft_handle_precision(t_conv *cd, char *str, char v, int *sign)
{
	char	*tstr;
