...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/07 15:40:50 by dmenard           #+#    #+#             */
/*   Updated: 2017/01/07 15:41:16 by dmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				pcft_lu(va_list ap, t_conv *cd)
{
	unsigned long int	v;
	char				*str;
	char				padc;
	...
	v = (unsigned long int)va_arg(ap, uintmax_t);
