...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/07 15:29:23 by dmenard           #+#    #+#             */
/*   Updated: 2017/01/08 17:06:26 by dmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				pcft_ho(va_list ap, t_conv *cd)
{
	...
	v = (unsigned short int)va_arg(ap, uintmax_t);
	less = 0;
