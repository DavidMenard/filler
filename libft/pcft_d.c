...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/04 07:37:06 by dmenard           #+#    #+#             */
/*   Updated: 2017/01/07 13:34:04 by dmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char		*spft_precipad(char *str, int value, t_conv *cd)
{
	char	*tstr;
...
static char		*spft_handle_precision(t_conv *cd, char *str, int v, int *sign)
{
	char	*tstr;
...
int				pcft_d(va_list ap, t_conv *cd)
{
	int		v;
	char	*str;
	char	padc;
